...
def index2():
    ...
    data = cur.fetchall()
    return render_template('index2.html', contactos=data)
...
def add_contact():
    ...
    if request.method == 'POST':
        ...
        cur= mysql.connection.cursor()
        cur.execute('insert into pedidos(producto, cantidad, marca, tamanio) values(%s, %s, %s, %s)', (producto, cantidad, marca, tamanio))
        mysql.connection.commit()
